...
# 	series['WATERLVEL'] = series['WATERLVEL']/1000
...
def analyze(series):
	...
	scaler.fit(series)
	series = scaler.transform(series)
	series = pd.DataFrame(series, columns=['WATERLEVEL','RF_DIGKILAAN','RF_ROGONGON','i-1','i-2','i-3','DAY', 'TIME', 'YEAR'])
...
def train(series):
	...
	series = series[['WATERLEVEL','RF_DIGKILAAN','RF_ROGONGON','i-1','i-2','i-3','DAY', 'TIME', 'YEAR']]
	print("Normalized: ")
	print(series)
...
def predict(series, button_, cons, eps, p, gam):
	...
	X = series[['WATERLEVEL','RF_DIGKILAAN','RF_ROGONGON','i-1','i-2','i-3','DAY', 'TIME', 'YEAR']]
	y = series[['WATERLEVEL']]
